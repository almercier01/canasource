/*
  # Create business images table and policies

  1. New Table
    - Creates business_images table to track image uploads
    - Adds status tracking for image moderation
    - Links images to businesses and approvers
  
  2. Security
    - Enables RLS
    - Adds policies for viewing and managing images
